...
class DeliveryAPITestCase(AuthenticatedResourceTestCase):
    ...
    def test_is_readonly(self):
        d = Delivery.objects.create(project_id='project1', from_user_id='user1', to_user_id='user2',
    ...
    def test_lists_only_deliveries_sent_by_user(self):
        sent = Delivery.objects.create(project_id='project1', from_user_id='user1', to_user_id='user2',
                                       transfer_id=self.transfer_id1)
        received = Delivery.objects.create(project_id='project2', from_user_id='user2', to_user_id='user1',
                                           transfer_id=self.transfer_id2)
        unrelated = Delivery.objects.create(project_id='project3', from_user_id='user2', to_user_id='user3',
...
#
#         Delivery.objects.create(project_id='delivering-project',
#                                 from_user_id='user1',
#                                 to_user_id='user2',
#                                 transfer_id=self.transfer_id1)
#         Delivery.objects.create(project_id='receiving-project',
#                                 from_user_id='user2',
#                                 to_user_id='user1',
#                                 transfer_id=self.transfer_id2)
#         Delivery.objects.create(project_id='unrelated-project',
#                                 from_user_id='user2',
#                                 to_user_id='user3',
#                                 transfer_id=self.transfer_id3)
#
