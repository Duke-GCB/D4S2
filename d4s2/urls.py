...
urlpatterns = [
    ...
    url(r'^accounts/login/$', auth_views.login, {'template_name': 'ownership/login.html' }, name='login'),
    url(r'^accounts/logout/$', auth_views.logout, {'template_name': 'ownership/logged_out.html' }, name='logout'),
