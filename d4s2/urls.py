...
urlpatterns = [
    ...
    url(r'^accounts/logout/$', auth_views.LogoutView.as_view(template_name='gcb_web_auth/logged_out.html'),
        name='logout'),
    url(r'^accounts/login-local/$', auth_views.LoginView.as_view(template_name='gcb_web_auth/login-local.html'),
        name='login-local'),
